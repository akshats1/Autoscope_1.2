...
class Motor:
    def __init__(self):
        self.xcclk = b'xcclk'  # Counter-clockwise command for motor 1
        self.xclk = b'xclk'    # Clockwise command for motor 1
        self.yclk = b'yclk'    # Clockwise command for motor 2
        self.ycclk = b'ycclk'  # Counter-clockwise command for motor 2
        self.zclk = b'zclk'    # Clockwise command for motor 3
        self.zcclk = b'zcclk'  # Counter-clockwise command for motor 3
